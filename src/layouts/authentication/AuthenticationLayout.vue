...
<body class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
      <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-primaryOne text-white bg-no-repeat bg-cover relative"
        style="background-image: url();">
        <div class="absolute bg-gradient-to-b from-primaryOne to-primaryTwo opacity-75 inset-0 z-0"></div>
        <div class="w-full max-w-md z-10">
          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Borges...</div>
